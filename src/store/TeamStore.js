...
import ZhouYan from "../img/teamer/ZhouYan.jpg"
...
const ChenZhihengIntro = ['上海交通大学电子信息与电气工程学院自动化专业2022级本科生。曾获2023年美国大学生建模竞赛F奖、第二十八期“上海交通大学大学生创新实践计划”一等奖。'];

const ZhouShengmiIntro = ['武汉大学弘毅学堂数字经济试验班2022级本科生。曾获2023“外研社·国才杯”全国大学生外语能力大赛阅读赛项武汉大学一等奖。'];

const ZhouYanIntro = ['武汉大学历史学院2023级历史学类本科生，曾获武汉大学2024年社会活动积极分子、武汉大学2024年学生寒假社会实践活动团体一等奖、武汉大学第六届“观世界·论中国”大学生学术论坛作品评比三等奖等奖项。'];
...
const AllTeamers = [
    ...
    { img: ZhouYan, name:"周言", intro: ZhouYanIntro, introShort: "武汉大学历史学院2023级历史学类本科生" },
];

export default AllTeamers;